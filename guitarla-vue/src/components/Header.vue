                                ...
                                <table class="w-100 table">
                                    ...
                                    <tbody>
                                        <tr
                                            ...
                                            v-for="produto in carrito"
                                            :key="produto.id"
                                        >
                                            <td>
                                                <img
                                                    class="img-fluid" 
                                                    :src="'/img/' + produto.imagen + '.jpg'"
                                                    :alt="'imagen guitarra ' + produto.nombre"
                                                >
                                            </td>
                                            <td>
                                                {{ produto.nombre }}
                                            ...
                                            <td class="flex align-items-start gap-4">
                                                <button
                                                    type="button"
                                                    class="btn btn-dark"
                                                    @click="$emit('decrementar-cantidad', produto.id)"
                                                >
                                                    -
                                                </button>
                                                    {{ produto.cantidad }}
                                                <button
                                                    type="button"
                                                    class="btn btn-dark"
                                                    @click="$emit('incrementar-cantidad', produto.id)"
                                                >
                                                    +
                                                </button>
                                            </td>
                                            <td>
                                                <button
                                                    ...
                                                    type="button"
                                                    @click="$emit('eliminar-producto', produto.id)"
                                                >
                                                    X
                                                </button>
                                            </td>
